...
/*   Updated: 2019/12/23 18:51:16 by rmarni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_binary_search(t_room *rooms, int start,
					int end, char *str);
...
int					get_min_level(t_room *room, int	pos, int visit);
...
int					init_value_count_ways(int mas[2],
					int *q, int *count, t_str *lem);
